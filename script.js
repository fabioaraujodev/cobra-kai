...
Game.Draw = function(context, snake) {
  ...
  this.drawStage = function() {
    ...
    for (var i = 0; i < snake.stage.length.length; i++) {
      ...
      this.drawCell(cell.x, cell.y,"orange"); // corpo da cobrinha
    }

    this.drawCell(snake.stage.food.x, snake.stage.food.y, "red"); // frutinha
    
    // texto dos pontos, fica com a ultima cor (frutinha)
